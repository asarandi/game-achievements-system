...
type typeAsf struct {
	...
	slug        string
	function    func(Stat) bool
}

/*
	the `slug` string should match the `slug` column in achievements sql table
*/
var (
	asf = []typeAsf{
...
/*
	"sharpshooter award" - a user receives this for landing 75% of their attacks, if they have at least attacked once.
*/
